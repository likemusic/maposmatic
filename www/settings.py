...
WARNING: do not edit this file it could be overwritten by updates!
Instead edit www/settings_local.py
"""
...
try:
    ...
    print('Unable to load www/settings_local.py. You probably need to '
          'customize some default configuration. Copy and edit '
          'www/settings_local.py.dist.')
...
try:
    ...
    raise type(e)("Cannot open '{}'. Check your OCITYSMAP_CFG_PATH settings "
                  "in 'www/settings_local.py'".format(OCITYSMAP_CFG_PATH))
